const translations = {
    en: {
        ...
        'hero.title': 'Free and powerful Modbus utility',
        'hero.subtitle': 'Professional Modbus Master (Client) supporting both Modbus-TCP and Modbus-RTU protocols',
        'hero.btn.download': 'Download',
        'hero.btn.github': 'View on GitHub',
        'features.title': 'Features',
        'feature1.title': 'Modbus Functions',
        'feature1.desc': 'Support for all standard Modbus functions: Read/Write Coils, Discrete Inputs, Holding Registers, Input Registers',
        'feature2.title': 'Device Scanner',
        'feature2.desc': 'Built-in Modbus device scanner with support for RTU, TCP and RTU over TCP protocols',
        'feature3.title': 'Message Logging',
        'feature3.desc': 'Comprehensive logging of all Modbus communication with message parsing capabilities',
        'feature4.title': 'Custom Messages',
        'feature4.desc': 'Send custom Modbus messages for advanced testing and debugging scenarios',
        'feature5.title': 'Modbus Protocols',
        'feature5.desc': 'Full support for both Modbus-TCP (Ethernet) and Modbus-RTU (Serial) protocols',
        'feature6.title': 'Cross-Platform',
        'feature6.desc': 'Available for Windows and Linux with native performance on both platforms',
        'screenshots.title': 'Screenshots',
        'download.title': 'Download OpenModScan',
        ...
        'build.desc': 'OpenModScan is open source and can be built from source code. Visit the <a href="https://github.com/sanny32/OpenModScan#building">GitHub repository</a> for build instructions.',
        'footer.brand.desc': 'Free and open-source Modbus Master utility',
        'footer.links': 'Links',
    ...
    ru: {
        ...
        'hero.title': 'Бесплатная и мощная утилита Modbus',
        'hero.subtitle': 'Профессиональный Modbus Master (клиент) с поддержкой протоколов Modbus-TCP и Modbus-RTU',
        'hero.btn.download': 'Скачать',
        'hero.btn.github': 'Открыть на GitHub',
        'features.title': 'Возможности',
        'feature1.title': 'Функции Modbus',
        'feature1.desc': 'Поддержка всех стандартных функций Modbus: чтение/запись катушек, дискретных входов, регистров хранения и входных регистров',
        'feature2.title': 'Сканер устройств',
        'feature2.desc': 'Встроенный сканер Modbus-устройств с поддержкой протоколов RTU, TCP и RTU over TCP',
        'feature3.title': 'Журналирование сообщений',
        'feature3.desc': 'Полное журналирование всего трафика Modbus с возможностью разбора сообщений',
        'feature4.title': 'Произвольные сообщения',
        'feature4.desc': 'Отправка произвольных Modbus-сообщений для расширенного тестирования и отладки',
        'feature5.title': 'Протоколы Modbus',
        'feature5.desc': 'Полная поддержка Modbus-TCP (Ethernet) и Modbus-RTU (последовательный порт)',
        'feature6.title': 'Кроссплатформенность',
        'feature6.desc': 'Доступен для Windows и Linux с нативной производительностью на обеих платформах',
        'screenshots.title': 'Скриншоты',
        'download.title': 'Скачать OpenModScan',
        ...
        'build.desc': 'OpenModScan является программным обеспечением с открытым исходным кодом и может быть собран из исходников. Посетите <a href="https://github.com/sanny32/OpenModScan#building">репозиторий GitHub</a> для получения инструкций по сборке.',
        'footer.brand.desc': 'Бесплатная утилита Modbus Master с открытым исходным кодом',
        'footer.links': 'Ссылки',
    ...
    zh_CN: {
        ...
        'nav.screenshots': '截图',
        'nav.download': '下载',
        'hero.title': '免费且强大的 Modbus 工具',
        'hero.subtitle': '专业的 Modbus 主站（客户端），支持 Modbus-TCP 和 Modbus-RTU 协议',
        'hero.btn.download': '下载',
        'hero.btn.github': '在 GitHub 查看',
        'features.title': '功能特性',
        'feature1.title': 'Modbus 功能',
        'feature1.desc': '支持所有标准 Modbus 功能：读取/写入线圈、离散输入、保持寄存器和输入寄存器',
        'feature2.title': '设备扫描器',
        'feature2.desc': '内置 Modbus 设备扫描器，支持 RTU、TCP 和 RTU over TCP 协议',
        'feature3.title': '消息记录',
        'feature3.desc': '全面记录所有 Modbus 通信，具有消息解析功能',
        'feature4.title': '自定义消息',
        'feature4.desc': '发送自定义 Modbus 消息，用于高级测试和调试场景',
        'feature5.title': 'Modbus 协议',
        'feature5.desc': '完全支持 Modbus-TCP（以太网）和 Modbus-RTU（串口）协议',
        'feature6.title': '跨平台',
        'feature6.desc': '适用于 Windows 和 Linux，在两个平台上均具有原生性能',
        'screenshots.title': '截图',
        'download.title': '下载 OpenModScan',
        ...
        'build.title': '从源码构建',
        'build.desc': 'OpenModScan 是开源软件，可以从源代码构建。请访问 <a href="https://github.com/sanny32/OpenModScan#building">GitHub 仓库</a> 获取构建说明。',
        'footer.brand.desc': '免费开源的 Modbus 主站工具',
        'footer.links': '链接',
    ...
    zh_TW: {
        ...
        'nav.screenshots': '截圖',
        'nav.download': '下載',
        'hero.title': '免費且強大的 Modbus 工具',
        'hero.subtitle': '專業的 Modbus 主站（客戶端），支援 Modbus-TCP 和 Modbus-RTU 協定',
        'hero.btn.download': '下載',
        'hero.btn.github': '在 GitHub 查看',
        'features.title': '功能特性',
        'feature1.title': 'Modbus 功能',
        'feature1.desc': '支援所有標準 Modbus 功能：讀取/寫入線圈、離散輸入、保持暫存器和輸入暫存器',
        'feature2.title': '裝置掃描器',
        'feature2.desc': '內建 Modbus 裝置掃描器，支援 RTU、TCP 和 RTU over TCP 協定',
        'feature3.title': '訊息記錄',
        'feature3.desc': '全面記錄所有 Modbus 通信，具有訊息解析功能',
        'feature4.title': '自訂訊息',
        'feature4.desc': '發送自訂 Modbus 訊息，用於進階測試和除錯場景',
        'feature5.title': 'Modbus 協定',
        'feature5.desc': '完全支援 Modbus-TCP（乙太網路）和 Modbus-RTU（串列埠）協定',
        'feature6.title': '跨平台',
        'feature6.desc': '適用於 Windows 和 Linux，在兩個平台上均具有原生性能',
        'screenshots.title': '截圖',
        'download.title': '下載 OpenModScan',
        ...
        'build.title': '從原始碼構建',
        'build.desc': 'OpenModScan 是開源軟體，可以從原始碼構建。請訪問 <a href="https://github.com/sanny32/OpenModScan#building">GitHub 倉庫</a> 獲取構建說明。',
        'footer.brand.desc': '免費開源的 Modbus 主站工具',
        'footer.links': '連結',
...
function applyTranslations(lang) {
    ...
    localStorage.setItem('omodscan-lang', lang);
}

window.updateSubtitleWithVersion = function(version) {
    window.releaseVersion = version;
    const lang = localStorage.getItem('omodscan-lang') || 'en';
    const t = translations[lang] || translations['en'];
...
document.addEventListener('DOMContentLoaded', () => {
    ...
    const saved = localStorage.getItem('omodscan-lang');
