    ...
    switch(_mm->function())
    {
        ...
        if(_mm->isRequest())
            {
                ...
                addField(tr("Start Address"), QString("%1 %2").arg(startAddress, addrBase), dataColor);
        ...
        if(_mm->isRequest())
            ...
            const auto outputAddress = req->isValid() ? formatUInt16Value(_dataDisplayMode, req->address()) : "??";
                ...
                addField(tr("Output Address"), QString("%1 %2").arg(outputAddress, addrBase), dataColor);
        ...
        if(_mm->isRequest())
            {
                ...
                addField(tr("Register Address"), QString("%1 %2").arg(registerAddress, addrBase), dataColor);
                addField(tr("Register Value"), registerValue, dataColor);
            }
            else
            {
        ...
        case QModbusPdu::WriteMultipleCoils:
            if(_mm->isRequest())
            {
                ...
                addField(tr("Starting Address"), QString("%1 %2").arg(startAddr, addrBase), dataColor);
                addField(tr("Quantity of Outputs"), quantity, dataColor);
                addField(tr("Byte Count"), byteCount, dataColor);
                addField(tr("Output Value"), values, dataColor);
            }
            else
            {
        ...
        if(_mm->isRequest())
            {
                ...
                addField(tr("Address"), QString("%1 %2").arg(address, addrBase), dataColor);
        ...
        if(_mm->isRequest())
            {
                ...
                addField(tr("Read Starting Address"), QString("%1 %2").arg(readStartAddr, addrBase), dataColor);
                addField(tr("Quantity to Read"), readLength, dataColor);
                addField(tr("Write Starting Address"), QString("%1 %2").arg(writeStartAddr, addrBase), dataColor);
        ...
        if(_mm->isRequest())
            {
                ...
                addField(tr("FIFO Point Address"), QString("%1 %2").arg(fifoAddr, addrBase), dataColor);
            }
            else
            {
